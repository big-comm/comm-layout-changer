...
TRANSLATIONS = {
    "en": {
        "window_title": "Community's Layout Switcher",
        "layouts_tab": "Layouts",
        "effects_tab": "Effects",
        "themes_tab": "Themes",
        ...
        "about_title": "About Community's Layout Switcher",
        "about_description": "Customize your GNOME desktop appearance",
        "quit_confirm": "Are you sure you want to quit?",
        "quit_confirm_title": "Quit Community's Layout Switcher"
    },
    "es": {
        "window_title": "Cambiador de Diseños de Community",
        "layouts_tab": "Diseños",
        "effects_tab": "Efectos",
        "themes_tab": "Temas",
        ...
        "about_title": "Acerca del Cambiador de Diseños de Community",
        "about_description": "Personaliza la apariencia de tu escritorio GNOME",
        "quit_confirm": "¿Estás seguro de que quieres salir?",
        "quit_confirm_title": "Salir del Cambiador de Diseños de Community"
    },
    "fr": {
        "window_title": "Commutateur de Disposition de Community",
        ...
        "about_title": "À propos du Commutateur de Disposition de Community",
        "about_description": "Personnalisez l'apparence de votre bureau GNOME",
        "quit_confirm": "Êtes-vous sûr de vouloir quitter?",
        "quit_confirm_title": "Quitter le Commutateur de Disposition de Community"
    },
    "de": {
        "window_title": "Communitys Layout-Wechsler",
        "layouts_tab": "Layouts",
        "effects_tab": "Effekte",
        "themes_tab": "Themen",
        ...
        "about_title": "Über Communitys Layout-Wechsler",
        ...
        "quit_confirm_title": "Communitys Layout-Wechsler beenden"
    },
    "pt_BR": {
        "window_title": "Alternador de Layouts da Community",
        "layouts_tab": "Layouts",
        "effects_tab": "Efeitos",
        "themes_tab": "Temas",
        ...
        "about_title": "Sobre o Alternador de Layouts da Community",
        "about_description": "Personalize a aparência da sua área de trabalho GNOME",
        "quit_confirm": "Tem certeza de que deseja sair?",
        "quit_confirm_title": "Sair do Alternador de Layouts da Community"
    }
}
...
class BigAppearanceApp(Adw.Application):
    def __init__(self):
        super().__init__(application_id='org.community.comm-layout-switcher')
    ...
    def on_about(self, action, param):
        ...
        about_dialog.set_icon_name("org.community.comm-layout-switcher")
